...
export const MainPageMainContent = () => {
    return (
        <div className="w-screen h-[75vh] bg-center bg-cover bg-no-repeat bg-[url('/principal-background.jpg')] flex flex-col items-start px-8 py-8 mx-auto max-w-full text-left">
            ...
            <div className='h-full flex flex-col md:items-normal w-full max-w-5xl space-y-6 md:space-y-0 md:space-x-6'>
                ...
                <div className='flex flex-col justify-end md:justify-normal flex-1 space-y-2 text-left'>
                    <h1 className='text-5xl font-extrabold tracking-tight leading-tight text-neutral-50 md:text-neutral-900 md:text-6xl lg:text-7xl'>
                        Fundación Trayenko
                    </h1>
